...
def test_collect_marks6(monkeypatch): #passed
    inputs = iter(['90', '85', '75', '95', '80'])
    monkeypatch.setattr('builtins.input', lambda _: next(inputs))
    result = collect_marks()
    assert result == (90, 85, 75, 95, 80)

# Testing calculate_overall_mark function
# This part isn't completed yet
 
 #from Calculator import calculate_overall_mark

#def test_calculate_overall_mark(calculate_overall_mark):